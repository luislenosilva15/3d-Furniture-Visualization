...
using TMPro;
    ...
    public class LineRendererDrawing : SingleToneManager<LineRendererDrawing>
    {
        ...
        public GameObject distanceTextUI;
        ...
        void Start()
        {
            ...
            textObj = Instantiate(distanceTextUI.gameObject, Vector3.zero, Quaternion.identity);
        ...
        void DrawLength(Vector3 pointOne, Vector3 pointTwo, float distance, float yAngle, bool done)
        {
            ...
            if (done)
            {
                textObj = Instantiate(distanceTextUI.gameObject, point, Quaternion.identity);
